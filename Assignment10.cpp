/*Problem Statement:Department maintains student information .The file contains rollno,name,division and address.Allow user to add delete information of student.If record of student does not exist then an appropriate message is displayed.If it is then system display student details.Use sequential file to maintain data.
