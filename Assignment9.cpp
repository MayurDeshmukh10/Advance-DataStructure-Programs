/*Problem Statement:Read the marks obtained by students of second year in online exam of particular subject .Find out maximum and minimum marks obtained in that subject .Use heap data structure.Analyze the algorithm.
